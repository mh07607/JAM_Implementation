...
from jam_impl.codec.parse_header import spec_globals

def parse_extrinsic(b: bytes, spec: str = "full"):
    r = util.Reader(b)
    with spec_globals(spec):
        votes_count = util.NUM_VALIDATORS_IN_EPOCH_MARK // 3 * 2 + 1   # validators-super-majority
        # ------------ tickets
...
if __name__ == "__main__":
    b = None
    with open("/home/arsalan/repos/JAM_Implementation/jamtestvectors/codec/tiny/extrinsic.bin", "rb") as f:
        b = f.read()
    parse_extrinsic(b, "tiny")